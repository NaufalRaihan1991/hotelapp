            ...
            <div class="bg-white flex flex-col p-4 gap-6 rounded-xl mx-[18px]">
                    ...
                    <div id="Hotel-details" class="flex flex-col p-4 gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px]">
                                <p class="font-semibold text-sm leading-[21px] text-[#4041DA]">{{$hotelBooking->checkin_at->format('M d')}} - {{$hotelBooking->checkout_at->format('M d Y')}} ({{$hotelBooking->total_days}} Night)</p>
                            ...
                            <div class="flex flex-col gap-4 p-4 pb-0 mb-4">
                                <div class="flex items-center justify-between">
                                    <div class="title-container flex flex-col gap-[2px]">
                                        ...
                                        <p class="font-medium text-sm leading-[21px] text-[#757C98]">Max.{{$hotelBooking->room->total_people}} /Room</p>
                                    </div>
                ...
                <div id="Location-details" class="bg-white flex flex-col gap-3">
                    ...
                    <div id="embed-map-display" class="w-full aspect-[357/180] overflow-hidden">
                        <iframe id="map-iframe" class="w-full h-full z-0" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q={{$hotelBooking->hotel->name}}&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
                    </div>
